...
{
    [ContentProcessor(DisplayName = "Jack Font Texture - MonoGame")]
    public class JackFontTextureProcessor : ContentProcessor<Texture2DContent, SpriteFontContent>
    {
        ...
        public JackFontTextureProcessor()
        {
            FirstCharacter = ' ';
    ...
    {
        public static Bitmap ToSystemBitmap(this BitmapContent bitmapContent)
        {
